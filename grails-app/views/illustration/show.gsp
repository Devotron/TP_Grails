    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="list" action="index"><g:message code="default.list.label.illustration"/></g:link></li>
                <li><g:link class="create" action="create"><g:message code="default.new.label.illustration"/></g:link></li>
            </ul>
        </div>
        <div id="show-illustration" class="content scaffold-show" role="main">
            <h1>Détail illustration</h1>
            <g:if test="${flash.message}">
            <div class="message" role="status">${flash.message}</div>
            </g:if>
            <f:display bean="illustration" />
            <img src="${grailsApplication.config.fileServerUrl}${this.illustration.nom}" />
